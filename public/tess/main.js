...
var SimulationMultithreaded = (function () {
    function SimulationMultithreaded() {
        ...
        this.layersCount = 0;
        this.worker = new Worker("/tess/worker.js?v=".concat(Page.version));
...
var Color = (function () {
    ...
    Color.random = function () {
        var spread = (Math.random() + Math.random() - 1) * 132;
        var h = ((((120 + spread) % 360) + 360) % 360) / 360;
        var s = 0.28 + Math.random() * 0.57;
        var l = 0.32 + Math.random() * 0.28;
    ...
    Color.GREEN_ANCHOR = { r: 74, g: 132, b: 84 };
    Color.GREEN_ANCHOR_PULL = 0.055;
